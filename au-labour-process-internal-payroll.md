...
After employees are entered into the Human Resources module they are then entered into the Payroll module. All employee maintenance such as applications, updates topay details, bank details and tax information is maintained on the Payroll Employee Card.

To access the Employee Maintenance task Click the “Payroll Employee Card” button or go to the following menu: 

*Departments/Payroll/EmployeeMaintenance/Payroll Employees*
...
|**G.S.T. Exempt**|This relates to the setup of an Incor Comp Policy No” is used to record a Contractors policy number.|
